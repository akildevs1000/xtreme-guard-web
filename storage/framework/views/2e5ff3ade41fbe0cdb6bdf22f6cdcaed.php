                ...
                <nav class="box-navigation text-center">
                    ...
                    <ul class="box-nav-ul d-flex align-items-center justify-content-center">
                        <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="menu-item <?php echo e(request()->is($item['pattern']) ? 'active' : ''); ?>">
                                <a href="<?php echo e($item['url']); ?>" class="item-link">
                                ...
                                <?php if(!empty($item['sub']) && $item['name'] === 'Category'): ?>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            <div class="row-demo">
                                                <?php $__currentLoopData = $item['sub']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="demo-item active">
                                                        <a href="home-fashion-eleganceNest.html">
                                                            <div class="demo-image position-relative"
                                                                style="height: 80%">
                                                                <img class="lazyload" data-src="<?php echo e($category->img); ?>"
                                                            ...
                                                            <span class="demo-name mt-2"><?php echo e($category->name); ?></span>
                                                        </a>
                                                    </div>
...
<?php if(request()->is('/')): ?>
    <?php if (isset($component)) { $__componentOriginal6f86f3cbcaa5b14f1e5692c3bd87a761 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6f86f3cbcaa5b14f1e5692c3bd87a761 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.site.header.banner','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal6f86f3cbcaa5b14f1e5692c3bd87a761)): ?>
<?php $attributes = $__attributesOriginal6f86f3cbcaa5b14f1e5692c3bd87a761; ?>
<?php unset($__attributesOriginal6f86f3cbcaa5b14f1e5692c3bd87a761); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal6f86f3cbcaa5b14f1e5692c3bd87a761)): ?>
<?php $component = $__componentOriginal6f86f3cbcaa5b14f1e5692c3bd87a761; ?>
<?php unset($__componentOriginal6f86f3cbcaa5b14f1e5692c3bd87a761); ?>
<?php endif; ?>
<?php endif; ?>
...
<!-- /mobile menu -->
<?php /**PATH D:\Install\laragon\www\akil\resources\views/include/site/header.blade.php ENDPATH**/ ?>