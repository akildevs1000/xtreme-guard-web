            ...
            <div class="card" id="blogList">
                <div class="card-header py-2">
                    <div class="row align-items-center g-3">
                        <div class="col-md-3">
                            <h5 class="card-title mb-0"><?php echo e($title ?? 'Blog Posts'); ?></h5>
                        </div>
        ...
        <script>
            ...
            function loadBlogTable() {
                var table = $('#datatable-blog').DataTable({
                    ...
                    scrollY: "50vh",
                    ajax: {
                        url: '<?php echo e(url('admin/blogs')); ?>', // Change API endpoint for blogs
                    },
                    columns: [{
                            data: 'id',
                            name: 'id'
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Install\laragon\www\akil\resources\views/pages/blog/index.blade.php ENDPATH**/ ?>