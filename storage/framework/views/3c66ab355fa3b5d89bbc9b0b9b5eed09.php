                    ...
                    <div class="testimonial-item hover-img">
                        <div class="img-style">
                            <img data-src="images/testimonial/tes-1.jpg"
                                src="<?php echo e(asset('site/images/testimonial/tes-1.jpg')); ?>" alt="img-testimonial">
                        ...
                        <div class="content">
                            ...
                            <div class="box-avt">
                                <div class="avatar avt-60 round">
                                    <img src="<?php echo e(asset('site/images/avatar/user-4.jpg')); ?>" alt="avt">
                                </div>
                                <div class="box-price">
                    ...
                    <div class="testimonial-item hover-img">
                        <div class="img-style">
                            <img data-src="images/testimonial/tes-2.jpg"
                                src="<?php echo e(asset('site/images/testimonial/tes-2.jpg')); ?>" alt="img-testimonial">
                            <a href="#quickView" data-bs-toggle="modal" class="box-icon hover-tooltip center">
                                <span class="icon icon-eye"></span>
                                <span class="tooltip">Quick View</span>
                            </a>
                        ...
                        <div class="content">
                            ...
                            <div class="box-avt">
                                <div class="avatar avt-60 round">
                                    <img src="<?php echo e(asset('site/images/avatar/user-5.jpg')); ?>" alt="avt">
                                </div>
                                <div class="box-price">
                                    <p class="text-title text-line-clamp-1">Contrasting sheepskin sweatshirt</p>
                                    <div class="text-button price">$60.00</div>
...
<?php /**PATH D:\Install\laragon\www\akil\resources\views/components/site/home/testimonial.blade.php ENDPATH**/ ?>