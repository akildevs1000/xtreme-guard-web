...
<body>
    ...
    <div class="row dot mt-0" style="">
        ...
        <div class="col-5" style="background-color: resd;text-align:left">
            {{-- <div style="margin-right:15px;align-items:right"> --}}
            <div class="flex-shrink-0 mt-sm-0 mt-3 border py-2 bg-info-subtle shadow-none bg-opacity-10"
                style="height:9%; padding:10px; align-items:left">
                <h6 class="mb-1">
                    <span class="text-muted fw-normal">Tax Invoice No:</span>
