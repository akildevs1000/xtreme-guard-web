    ...
    <div class="bg-warning-subtle">
        <div class="card-body pb-0 px-4">
            <div class="row mb-1">
                            ...
                            <div>
                                ...
                                <div class="hstack gap-3 flex-wrap">
                                    ...
                                    @if ($order->is_delivered)
                                        <div class="py-0 mx-0 ps-0 fs-12 badge bg-warning">
                                            <a href="#" {!! !$orderIsPickuped ? "onclick='returnOrderModel(" . json_encode($order) . ")'" : '' !!} title="Shipment Label"
                                                class="" style="display: flex; align-items: center;">
                                        ...
                                        <x-order.show.return-form-model :order="$order" />
                ...
                <x-order.show.export-btn :order="$order" class="d-block d-md-none" />
            </div>
            ...
            <div class="d-flex profile-wrapper">
                ...
                <ul class="nav nav-tabs-custom border-bottom-0 flex-grow-1" role="tablist" id="order-tabs">
                    @foreach ($tabs as $tab)
                        <li class="nav-item" role="presentation">
                            <a class="nav-link fw-semibold mt-2 {{ $loop->first ? 'active' : '' }}" data-bs-toggle="tab"
                ...
                <x-order.show.export-btn :order="$order" class="d-none d-md-block" />
            </div>
        </div>
    </div>
</div>
...
@push('scripts')
    <script>
        function returnOrderModel(payload) {
            // alert('ff');
