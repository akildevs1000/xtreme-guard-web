                            ...
                            <div class="container">
                                <div class="content-slider">
                                    <div class="box-title-slider">
                                        <div class="fade-item fade-item-1 heading title-display">Summer 2024 <br>
                                            Collection
                                        </div>
                                        <p class="fade-item fade-item-2 body-text-1">Fresh styles just in! Elevate your
                                            look.</p>
                                    </div>
                                    <div class="fade-item fade-item-3 box-btn-slider">
                                        <a href="shop-default-grid.html" class="tf-btn btn-fill"><span
