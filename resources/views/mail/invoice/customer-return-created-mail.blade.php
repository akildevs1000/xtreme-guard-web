...
<table width="100%" cellpadding="0" cellspacing="0"
    ...
    <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        <td class="content-block"
            ...
            We regret to inform you that your order is being returned.
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="content-block"
                        ...
                        <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">
                            The return process has now been initiated.</p>
                    </td>
                </tr>
                <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="content-block"
                ...
                <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="content-block"
                        ...
                        valign="top">
                        <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">
                            Your order will be picked up and returned to us. Please place your order near the door.
