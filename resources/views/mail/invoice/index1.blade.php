...
<div
    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; width:600px;min-width:600px;max-width:600px;text-align: center;">
    <div style="padding-top:5px;margin-bottom:0px; padding-left: 0px; font-family: 'Roboto', sans-serif;">
        <p>
    ...
    @php
        $url = "administration/mail-open/2/$order->order_id";
    @endphp
