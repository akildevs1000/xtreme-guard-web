                            ...
                            <div class="thumbs-slider">
                                <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom"
                                    ...
                                    <div class="swiper-wrapper stagger-wrap">
                                        ...
                                        {{-- <div class="swiper-slide stagger-item" data-color="gray">
                                            <div class="item">
                                                <img class="lazyload"
                                                    data-src="{{ asset('site/images/products/womens/women-1.jpg') }}"
                                                    src="{{ asset('site/images/products/womens/women-1.jpg') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="swiper-slide stagger-item" data-color="gray">
                                            <div class="item">
                                                <img class="lazyload"
                                                    data-src="{{ asset('site/images/products/womens/women-2.jpg') }}"
                                                    src="{{ asset('site/images/products/womens/women-2.jpg') }}"
                                                    alt="">
                                            </div>
                                        </div> --}}
                                ...
                                <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started"
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        {{-- <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('site/images/products/womens/women-3.jpg') }}" target="_blank"
                                                class="item" data-pswp-width="600px" data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    data-zoom="{{ asset('site/images/products/womens/women-3.jpg') }}"
                                                    data-src="{{ asset('site/images/products/womens/women-3.jpg') }}"
                                                    src="{{ asset('site/images/products/womens/women-3.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div> --}}

                                        {{-- <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('site/images/products/womens/women-1.jpg') }}" target="_blank"
                                                class="item" data-pswp-width="600px" data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    data-zoom="{{ asset('site/images/products/womens/women-1.jpg') }}"
                                                    data-src="{{ asset('site/images/products/womens/women-1.jpg') }}"
                                                    src="{{ asset('site/images/products/womens/women-1.jpg') }}"
                                                    alt="">
                                            </a>
                                        ...
                                        <div class="swiper-slide" data-color="gray">
                                            <a href="{{ asset('site/images/products/womens/women-2.jpg') }}"
                                                target="_blank" class="item" data-pswp-width="600px"
                                                data-pswp-height="800px">
                                                <img class="tf-image-zoom lazyload"
                                                    data-zoom="{{ asset('site/images/products/womens/women-2.jpg') }}"
                                                    data-src="{{ asset('site/images/products/womens/women-2.jpg') }}"
                                                    src="{{ asset('site/images/products/womens/women-2.jpg') }}"
                                                    alt="">
                                            </a>
                                ...
                                <div class="tf-product-info-choose-option">
                                    ...
                                    <div class="tf-product-info-guranteed">
                                        ...
                                        <div class="tf-payment">
                                            ...
                                            @for ($i = 1; $i < 7; $i++)
                                                <a href="#">
                                                    <img src='{{ asset("site/images/payment/img-$i.png") }}'
                                                        alt="">
                                                </a>
                                            @endfor
                    ...
                    <div class="col-12">
                        <form class="form-sticky-atc">
                            <div class="tf-sticky-atc-product">
                                <div class="image">
                                    <img class="lazyload"
                                        data-src="{{ asset('site/images/products/womens/women-3.jpg') }}" alt=""
                                        src="{{ asset('site/images/products/womens/women-3.jpg') }}">
                                </div>
                                <div class="content">
                                    <div class="text-title">
                            ...
                            <div class="widget-content-inner active">
                                <div class="tab-description">
                                    ...
                                    {{-- <div class="right">
                                        ...
                                        <p class="mb_12 text-secondary">Nodding to retro styles, this Hyperbola
                                            T-shirt is defined by its off-the-shoulder design. It's spun from a
                                            green stretch cotton jersey and adorned with an embroidered AC logo on
                                            the front, a brand's signature.</p>
                                        <p class="text-secondary">Thick knitted fabric. Short design. Straight
                                            design. Rounded neck. Sleeveless. Straps. Unclosed. Cable knit finish.
                                            Co-ord.</p>
                                    </div>
                                    <div class="left">
                                        ...
                                        <ul class="list-text type-disc mb_12 gap-6">
                                            <li class="font-2">Composition: 55% polyester, 30% acrylic, 13%
                                                polyamide, 2% elastane</li>
                                        ...
                                        <div class="text-caption-2">MACHINE WASHING MAX 30°C / 85ºF SHORT SPIN DRY
                                        </div>
                                    </div> --}}
                                </div>
                            </div>
