...
return new class extends Migration
{
    ...
    {
        Schema::create('pickup_shipments', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('pickup_id');
            $table->bigInteger('order_id');
            $table->string('pickup_shiping_reference_number')->nullable();
        ...
        Schema::create('pickup_shipment_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pickup_shipment_id');
            $table->unsignedBigInteger('pickup_shiping_reference_number')->nullable();
    ...
    {
        Schema::dropIfExists('pickup_shipments');
    }
};
